...
- [x] Модифицировать реализацию хэш-таблицы из
...
- [x] Написать тесты, проверяющие корректность работы в многопоточном режиме
...
- [x] (**Доп., +5 баллов**) Провести стресс-тестирование таблицы
...
- [x] (**Доп., +5 баллов**) Реализация хэш-таблицы должна быть основана не на multiprocessing.Manager,
