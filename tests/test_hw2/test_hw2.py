...
@pytest.mark.parametrize("input_data,func,expected", [
...
@pytest.mark.parametrize("input_data,pred,expected", [
...
@pytest.mark.parametrize("input_data,func,initializer,expected", [
